...
As discussed in~\ref{cite:bw-isifsd-15},
...
Seond, the isosurface vertex $\cb.\isov$ generated by cube $\cb$
may lie outside $\cb$.
Moreover, point $\cb.\isov$ may lie outside of $\cb$
even if the sharp edge containing $\cb.\isov$ intersects $\cb$.
...
Third, SHREC checks that if $\tcb$ is connected to three selected edge cubes,

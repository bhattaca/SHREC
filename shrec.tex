...
\newcommand {\centercol}[1] {\multicolumn{1}{c|}{#1}} % center column
...
\input{./sections/shrec_intro.tex}
\input{./sections/shrec_definitions.tex}
\input{./sections/shrec_related_work.tex}
\input{./sections/shrec_algorithm.tex}
\input{./sections/shrec_angle_distance.tex}
\input{./sections/shrec_results.tex}
\input{./sections/shrec_conclusion.tex}

\bibliographystyle{abbrv}
\bibliography{shrec}

\input {./sections/shrec_appendix.tex}
